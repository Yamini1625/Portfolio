...
import myImage from "../assets/about/image.jpeg";
    ...
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            I am passionate about transforming ideas into engaging digital experiences.
          </p>
...
>
  View My Work
          ...
          {showProjects && (
  <div className="mt-6 bg-red-600 rounded-2xl p-6 text-white shadow-2xl max-w-xl">
    ...
    <div className="flex items-center gap-4 mb-4">
      ...
      <div>
        <h2 className="text-2xl font-bold">Yamini</h2>
    ...
    <div className="mb-4">
      ...
      <p>
        Developed using Django for event registration,
        scheduling and participant management.
      </p>
    </div>

    <div className="mb-4">
      <h4 className="font-bold">Project Stuck Detector</h4>
      <p>
        A Python-based web application that analyzes source code,
        detects errors, identifies their locations, calculates time
        complexity, provides code quality ratings, and highlights
        error locations. The system helps developers debug and
